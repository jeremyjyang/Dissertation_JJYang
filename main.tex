...
\usepackage{enumitem} %better itemize lists
\usepackage[yyyymmdd,hhmmss]{datetime}

% To solve references in margin problem:
...
%format title font size and position
...
\begin{singlespace}
\setlength\cftbeforetabskip{\baselineskip}  %set spacing between entries
\listoftables
\end{singlespace}
...
\begin{singlespace}
\setlength\cftbeforefigskip{\baselineskip}  %set spacing between entries
\listoffigures
\end{singlespace}
...
% Chapter: Badapple
\input{chapter_badapple.tex}

% Chapter: TIGA
\input{chapter_tiga.tex}

% Chapter: KGAP
\input{chapter_kgap.tex}

% Chapter: Additional work
\input{chapter_additional.tex}
