...
\multicolumn{1}{c}{} & \multicolumn{4}{|c|}{\textbf{TDL}} &  \multicolumn{1}{c}{} \\
\hline
...
\hline
\textbf{genotype} & An organism has one genotype, comprised of a germ line genome and multiple somatic genomes. Statistical models may assume a population distribution hence a population genotype. \\
\hline
\textbf{phenotype} & An organism has one phenotype, comprised of (potentially) all non-genomic observable characteristics, a.k.a. phenotypic traits. \\
\hline
\textbf{gene} & Genomic unit responsible for an expression product. Protein coding genes are a subset of this definition.  \\
\hline
\textbf{trait} & Single non-genomic, observable characteristic. \\
\hline
\textbf{drug target} & Biomolecular entity involved in the mechanism of action of a drug. The IDG project is protein-centric; hence drug targets are all proteins. \\
\hline
\end{tabular}
\end{center}
\end{table}
