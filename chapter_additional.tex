...
\textbf{BFO = Basic Formal Ontology
...
\begin{tabular}{ccl}
\hline
\textbf{entity (abbr)} & \textbf{namespace} & \textbf{example} \\
...
endpoint & <http://rdf.ncbi.nlm.nih.gov/pubchem/endpoint/> & SID124893119\_AID1117354 \\
...
targetcomponent (target\_cmpt) & <http://rdf.ebi.ac.uk/resource/chembl/targetcomponent/> & CHEMBL\_TC\_1927 \\
...
activity & <http://rdf.ebi.ac.uk/resource/chembl/activity/> & CHEMBL\_ACT\_2470294 \\
...
\hline
\textbf{file} & \textbf{source} & \textbf{description} \newline
...
\texttt{substance:SID170466134 skos:exactMatch chembl\_molecule:CHEMBL1230222 \newline
