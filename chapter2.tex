...
\includegraphics[width=0.95\linewidth]{figures/KGAP_TINX_SYNRG3_rev3.png} 
\caption{}
\label{fig:TINXa}
\end{subfigure}
\begin{subfigure}{1.0\textwidth}
\includegraphics[width=0.95\linewidth]{figures/KGAP_TINX_SYNRG3articles_rev2.png}
\caption{}
\label{fig:TINXb}
\end{subfigure}
...
\begin{figure}
	\includegraphics[width=\textwidth]{figures/KGAP_SYNGR3_subnet.png}
...
\begin{figure}
	\includegraphics[width=\textwidth]{figures/KGAP_neo4jmetagraph.png}
